...
1. **Microcontroller sketch (`measure_uno_q.ino`)**
   ...
   * Handles timing, laser control, sensor reads, and the state machine.
...
* A measurement rig wired with:
  * Three TF-Luna I²C sensors connected directly with unique addresses (length=0x10, height=0x20, width=0x30).
